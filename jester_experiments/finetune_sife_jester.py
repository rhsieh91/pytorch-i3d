...
if __name__ == '__main__':
    ...
    d_train = VideoFolder(root="/vision/group/video/scratch/jester/rgb",
                          csv_file_input="./data/jester-v1-train-modified.csv",
                          csv_file_action_labels="./data/jester-v1-action-labels.csv",
                          csv_file_scene_labels="./data/jester-v1-scene-labels.csv",
                          clip_size=16,
                          nclips=1,
                          step_size=1,
                          is_val=False,
    ...
    d_val = VideoFolder(root="/vision/group/video/scratch/jester/rgb",
                        csv_file_input="./data/jester-v1-validation-modified.csv",
                        csv_file_action_labels="./data/jester-v1-action-labels.csv",
                        csv_file_scene_labels="./data/jester-v1-scene-labels.csv",
                        clip_size=16,
                        nclips=1,
